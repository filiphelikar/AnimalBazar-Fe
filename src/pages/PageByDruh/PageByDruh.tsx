...
const PageByDruh = () => {
  ...
  const [submitInput, setSubmitInput] = useState<string>(`http://localhost:3000/api/inzeraty/${id}`);
  ...
  return (
    <>
      <SearchBar setState={setSubmitInput} url='http://localhost:3000/api/search?param=' />
      {data && status === 'success' ?
